...
class RefundRequestPolicy
{
    ...
    {
        return $user->can('view_any_refund::request');
    }
    ...
    {
        return $user->can('view_refund::request');
    }
    ...
    {
        return $user->can('create_refund::request');
    }
    ...
    {
        return $user->can('update_refund::request');
    }
    ...
    {
        return $user->can('delete_refund::request');
    }
    ...
    {
        return $user->can('delete_any_refund::request');
    }
     ...
     */
    public function replicate(User $user, RefundRequest $refundRequest): bool
    {
